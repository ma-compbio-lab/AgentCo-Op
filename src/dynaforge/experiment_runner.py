...
from dynaforge.ir.schema import AtomicCondition, ConditionOp, FailureType, GateSpec, SubgraphSpec, TriggerExpr
...
def _ensure_squidpy_case_reference_assets(
    *,
    ...
    analysis_config = benchmark_settings.get("analysis_config", {})
    job_module = (
        "dynaforge.case_studies.squidpy_visium_interactions_job"
        if interaction_case
        else "dynaforge.case_studies.squidpy_visium_job"
    )
    cmd = [
        "python",
        "-m",
...
def _ensure_scanpy_paul15_reference_assets(
    *,
    ...
    cmd = [
        "python",
        "-m",
        "dynaforge.case_studies.scanpy_paul15_job",
        "--output-dir",
        str(reference_figure_path.parent),
        "--figure-path",
        str(reference_figure_path),
    ...
    *,
    ...
    completed = sandbox_runner.run_in_sandbox(
        ...
        [
            "python",
            "-m",
            "dynaforge.case_studies.visium_multi_agent_monolith_job",
            "--output-dir",
    ...
    return WorkflowBlueprint(
        ...
        mcp_servers=[
            MCPServerRef(
                name="scanpy_paul15",
                transport="stdio",
                stdio_cmd=["python", "-m", "dynaforge.case_studies.scanpy_paul15_server"],
                sandbox=sandbox,
            )
        ],
        base_nodes=[planner, tool_node, reviewer],
    ...
    return WorkflowBlueprint(
        ...
        mcp_servers=[
            MCPServerRef(
                ...
                transport="stdio",
                stdio_cmd=["python", "-m", "dynaforge.case_studies.paper_figure_specialist_server"],
                sandbox=paper_spec_sandbox,
            ),
            MCPServerRef(
        ...
        mcp_servers=[
            MCPServerRef(
                ...
                stdio_cmd=[
                    "python",
                    "-m",
                    "dynaforge.case_studies.squidpy_visium_interactions_server"
                    if interaction_case
                    else "dynaforge.case_studies.squidpy_visium_server",
                ],
                sandbox=sandbox,
            )
        ],
    ...
    return WorkflowBlueprint(
        ...
        mcp_servers=[
            MCPServerRef(
                ...
                transport="stdio",
                stdio_cmd=["python", "-m", "dynaforge.case_studies.scanpy_visium_cluster_server"],
                sandbox=scanpy_sandbox,
            ),
            MCPServerRef(
                name="squidpy_visium",
                transport="stdio",
                stdio_cmd=["python", "-m", "dynaforge.case_studies.squidpy_visium_interactions_server"],
                sandbox=squidpy_sandbox,
            ),
        ],
    ...
    return WorkflowBlueprint(
        ...
        mcp_servers=[
            MCPServerRef(
                ...
                transport="stdio",
                stdio_cmd=["python", "-m", "dynaforge.case_studies.visium_multi_agent_monolith_server"],
                sandbox=sandbox,
            )
        ],
        base_nodes=[planner, tool_node, reviewer],
...
def _scanpy_visium_cluster_tool_handler(node: NodeSpec, inputs: Mapping[str, Any], context: Any) -> NodeExecutionResult:
    ...
    return _run_direct_case_study_job(
        ...
        cmd=[
            "python",
            "-m",
            "dynaforge.case_studies.scanpy_visium_cluster_job",
            "--output-dir",
        ...
        selected_repo=selected_repo,
        tool_module="dynaforge.case_studies.scanpy_visium_cluster_job",
    )
...
def _visium_squidpy_interaction_tool_handler(node: NodeSpec, inputs: Mapping[str, Any], context: Any) -> NodeExecutionResult:
    ...
    return _run_direct_case_study_job(
        ...
        selected_repo=selected_repo,
        tool_module="dynaforge.case_studies.squidpy_visium_interactions_job",
    )
...
def _visium_multi_agent_monolith_tool_handler(node: NodeSpec, inputs: Mapping[str, Any], context: Any) -> NodeExecutionResult:
    ...
    return _run_direct_case_study_job(
        ...
        tool_module="dynaforge.case_studies.visium_multi_agent_monolith_job",
