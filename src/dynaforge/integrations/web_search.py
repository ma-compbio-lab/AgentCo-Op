...
from dynaforge.ir.schema import MCPServerRef, Transport

JsonDict = Dict[str, Any]

BUILTIN_WEB_SEARCH_SERVER = "builtin-web-search"
_DEFAULT_USER_AGENT = "dynaforge-web-search/0.1"
...
def build_builtin_web_search_server_ref() -> MCPServerRef:
    return MCPServerRef(
        ...
        stdio_cmd=[sys.executable, "-m", "dynaforge.integrations.web_search_server"],
        env={
