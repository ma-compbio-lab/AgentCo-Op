...
from agentcoop.ir import WorkflowBlueprint
...
from agentcoop.workflows.compiler import compile_workflow_from_config, extract_compiler_config
...
def build_executor_from_config(
    ...
    **overrides: Any,
    ...
    kwargs: dict[str, Any] = {
        "artifact_root": executor_cfg.get("artifact_root", ".agentcoop_artifacts"),
