...
from agentcoop.integrations.web_search import DuckDuckGoWebSearchClient
...
def main() -> None:
    try:
        ...
        raise SystemExit("Install the agentcoop[mcp] extra to run the builtin web-search MCP server") from exc
