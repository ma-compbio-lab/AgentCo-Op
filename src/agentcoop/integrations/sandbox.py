...
from agentcoop.ir.schema import MCPServerRef, SandboxBackend, SandboxSpec, Transport
...
class DockerSandboxRunner:
    ...
    def ensure_materialized(self, sandbox: SandboxSpec) -> MaterializedSandbox:
        ...
        container_name = sandbox.container_name or f"agentcoop-{sandbox.sandbox_id}"
...
class LocalVenvSandboxRunner:
    ...
    def __init__(
        self,
        *,
        sandbox_root: str | Path = ".agentcoop_sandboxes",
        git_cmd: str = "git",
