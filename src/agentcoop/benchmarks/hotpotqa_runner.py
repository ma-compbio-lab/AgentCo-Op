...
class HotpotQARunner(BenchmarkRunner):
    ...
    def prepare_dataset(self, resolved: Mapping[str, Any]) -> Dict[str, Any]:
        from agentcoop.benchmarks_lib import prepare_hotpotqa_dataset
        return prepare_hotpotqa_dataset(resolved)

    def build_task_blueprint(
        self, base_blueprint: WorkflowBlueprint, sample: Dict[str, Any]
    ) -> WorkflowBlueprint:
        from agentcoop.experiment_runner import build_hotpotqa_task_blueprint
        return build_hotpotqa_task_blueprint(base_blueprint, sample)
    ...
    def build_task_handlers(
        ...
        return {}  # No custom handlers for HotpotQA; uses default LLM routing
    ...
    def build_task_result(
        ...
        *,
        ...
        from agentcoop.experiment_runner import _build_hotpotqa_task_result
        return _build_hotpotqa_task_result(
            sample=sample,
